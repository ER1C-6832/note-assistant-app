...
Gate 5.4.1 根据真实 UI 验收新增 `ui.show_todos`，因此最终工具面由 31 修订为 32。Android-only archive、done、revision 或 tag rename 能力继续不得伪装为 PC 可用工具。

## 2. 文档清单

| 文件 | 用途 |
|---|---|
| `GATE5_MCP_NOTES_TOOLS_SPEC.md` | 总规格、最终工具目录、协议、安全、并发和生命周期契约 |
...
```text
5.0  MCP protocol core and initial registry
